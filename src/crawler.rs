...
impl WebCrawler {
    ...
    pub fn recorder_task(&self,scraper:Rc<scrape::Scraper>){
        let save = self.opts.output.to_str().expect("Cannot parse PathBuf into a &str in downloader task.");
    ...
    fn run_downloader(client:&reqwest::Client,scraper:Rc<scrape::Scraper>,save:&str,cuts:u32,tries:u32,wait:Option<f32>,retry_wait:f32,use_dir:bool,is_random:bool){
